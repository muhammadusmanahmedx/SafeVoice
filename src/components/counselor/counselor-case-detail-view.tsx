...
import { CounselorCaseDetail } from "@/components/counselor/case-detail";
import { useLanguage } from "@/components/providers/language-provider";
import type { CaseStatus } from "@/types";

interface CounselorCaseDetailViewProps {
  notFound?: boolean;
  caseData?: {
    id: string;
...
export function CounselorCaseDetailView({
  notFound,
  caseData,
  messages = [],
  notes = [],
  ...
  return (
    <div className="space-y-4">
      <Link href="/counselor/cases" className="text-sm text-primary hover:underline">
