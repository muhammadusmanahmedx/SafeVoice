...
export function FacultyRegisterForm() {
  ...
  return (
    <div className="w-full max-w-sm">
      <div className="mb-8">
        <h1 className="text-2xl font-extrabold tracking-tight text-[#193852]">Faculty Registration</h1>
        <p className="mt-1.5 text-sm text-gray-500">
          Register using your institution&apos;s faculty access code
        </p>
      </div>

      <form action={handleSubmit} className="space-y-4">
        <div className="space-y-1.5">
          <Label htmlFor="displayName" className="text-sm font-semibold text-[#193852]">Full name</Label>
          <Input
        ...
        <div className="space-y-1.5">
          <Label htmlFor="email" className="text-sm font-semibold text-[#193852]">Work email</Label>
          <Input
        ...
        <div className="space-y-1.5">
          <Label htmlFor="facultyCode" className="text-sm font-semibold text-[#193852]">Faculty access code</Label>
          <Input
            id="facultyCode" name="facultyCode" required
            placeholder="e.g. FAC-DEMO-RV001"
            className="h-10 rounded-xl border-gray-200 bg-gray-50 font-mono text-sm tracking-wider"
          />
          <p className="text-xs text-gray-400">Provided by your institution administrator</p>
        </div>
        ...
        >
          {loading ? (
            ...
            <>Register as Faculty <ArrowRight className="h-4 w-4" /></>
          )}
        </button>
      </form>
